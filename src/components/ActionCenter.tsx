  ...
  /* ── 대구시 담당자 업무 ── */
  {
    ...
    document: () => ({
      ...
      body:
        ...
        `2. 5563호 3회차 운행에 대해 배차기록상 정상운행으로 등록되었으나, ` +
  ...
  },
  {
    ...
    document: (s) => ({
      ...
      body:
        ...
        `[검증] 측정·보고·검증 절차로 실측 데이터 축적 중\n` +
        `[활용] 시 온실가스 감축 목표 실적 반영 + 향후 외부사업 방법론 인증 검토\n` +
        `※ 방법론 인증은 검토 단계이며, 인증 전 실적은 보수적으로 표기함.`,
    }),
    approveLabel: '검토·수정 후 확정',
