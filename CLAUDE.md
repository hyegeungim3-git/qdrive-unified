...
- 화면 6종: Ingest(표+드로어 4탭) / Quality(원천×룰 매트릭스·격리 드로어·**재처리 실동작**) / Ontology(노드 클릭 드로어·로그 스케일 막대·질의 실계산) / Datasets(정렬·드로어·서비스 딥링크) / Lineage(계보 딥링크·**영향도 분석**) / Operations(잡·저장·감사·SLA)
