...
const PHASES: {
...
}[] = [
  {
    ...
    frame: '오큐브 자체 자산만으로 즉시 착수 (대구시 부담 최소)',
    status: 'live',
    owner: '오큐브 자체 자산 (운행기록계·운행기록 자동제출)',
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { source: 'BIS', desc: '버스정보시스템 — 도착예측, 정류장별 지연 예측, 시민 안내정보 고도화' },
      { source: 'BMS', desc: '버스관리시스템 — 배차 최적화, 회차·우회·예비차 투입 추천' },
